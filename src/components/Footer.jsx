      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-2xl font-bold gradient-text mb-2 font-heading">GVLA</h2>
              ...
              {socialLinks.map((social) => {
                ...
                return (
                  <motion.a
                    key={social.name}
                    href={social.url}
                    className="p-2 bg-gradient-to-r from-blue-500 to-purple-500 bg-opacity-20 rounded-lg text-gray-300 hover:text-white hover-glow border border-blue-500 border-opacity-30"
